...
class CsmMsmTrainer(Trainer):
    def __init__(self, args):
        super(CsmMsmTrainer, self).__init__(args)
...
str2target = {"sp": SpTrainer, "csmmsm":CsmMsmTrainer, "mlm": MlmTrainer, "lm": LmTrainer,
              "bilm": BilmTrainer, "cls": ClsTrainer}
